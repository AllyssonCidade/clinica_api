...
export interface ApiAgendamentoAgendamento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    atendente: Schema.Attribute.Relation<
      'manyToOne',
      'api::atendente.atendente'
    >;
    atendimento: Schema.Attribute.Enumeration<
      ['emergencia', 'rotina', 'retorno']
    > &
      Schema.Attribute.DefaultTo<'rotina'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    profissional: Schema.Attribute.Relation<
      'manyToOne',
      'api::profissional.profissional'
    >;
    publishedAt: Schema.Attribute.DateTime;
    statusAgendamento: Schema.Attribute.Enumeration<
...
export interface ApiAtendenteAtendente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataContrato: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::atendente.atendente'
    ...
    senha: Schema.Attribute.Password &
      ...
      Schema.Attribute.DefaultTo<'Atendente123.'>;
    telefone: Schema.Attribute.Integer &
...
export interface ApiPacientePaciente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    senha: Schema.Attribute.Password &
      ...
      Schema.Attribute.DefaultTo<'Paciente123.'>;
    telefone: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 11;
...
export interface ApiProfissionalProfissional
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    especialidade: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::profissional.profissional'
    ...
    nome: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    registroProfissional: Schema.Attribute.String;
    senha: Schema.Attribute.Password &
      Schema.Attribute.Required &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
      ...
      Schema.Attribute.DefaultTo<'Profissional123.'>;
    telefone: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 11;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::atendente.atendente': ApiAtendenteAtendente;
